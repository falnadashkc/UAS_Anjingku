...
public class UbahActivity extends AppCompatActivity {
    private String yid, ynama, ywarna, ytentang, yasal, ykeunikan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ywarna = ambil.getStringExtra("xwarna");
        ytentang = ambil.getStringExtra("xtentang");
        yasal = ambil.getStringExtra("xasal");
        ykeunikan = ambil.getStringExtra("xkeunikan");
        ...
        etwarna.setText(ywarna);
        ettentang.setText(ytentang);
        etasal.setText(yasal);
        etkeunikan.setText(ykeunikan);
        ...
        private void ubahkampus(){
            ...
            Call<ModelRespon> proses = API.ardUpdate(yid,Nama, warna, tentang, asal, keunikan);
